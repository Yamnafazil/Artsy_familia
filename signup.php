...
<html lang="en">
    <head>
        ...
        <title>Signup | Artsy Familia</title>
                ...
                <div class="container" >
                    ...
                    <div class="col-lg-4 col-lg-offset-3 col-md-6">
                        ...
                        <form  action="signup_script.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control"  placeholder="Contact (ex. 03002533949)" maxlength="15" size="15" name="contact" required = "true"><?php if(isset($_GET['m2'])) echo $_GET['m2']; ?>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" name="submit" class="btn btn-light"style="background-color:#FF0066;color:white;">Submit</button>
                        </form>
                    </div>
